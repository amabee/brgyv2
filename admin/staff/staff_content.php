...
$sql = "SELECT * FROM staffs WHERE is_active = 0 ORDER BY id DESC";
...
<script>
    $(document).ready(function () {
        ...
        $('#tablebod').on('click', '.editbtn', function () {
            ...
            $.ajax({
                url: 'action/get_staff_by_id.php', // 
                method: 'POST',
