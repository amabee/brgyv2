...
$sql = "SELECT *,fp_information.id as id,patients.first_name as first_name,patients.last_name as last_name,nurses.first_name as first_name2,nurses.last_name as last_name2, fp_obstetrical_history.fp_information_id as fp_information_id
FROM fp_information
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <?php echo $row['date_of_last_delivery']; ?>
                                    </td>
                                    <td class="align-middle">
...
<script>
    $(document).ready(function () {
        ...
        $('#addButton').click(function () {
            ...
            //jaba
            var abnormal_discharge = $('#abnormal_discharge').is(':checked') ? 'Yes' : 'No';;
            var genital_sores_ulcers = $('#genital_sores_ulcers').is(':checked') ? 'Yes' : 'No';
            var genital_pain_burning_sensation = $('#genital_pain_burning_sensation').is(':checked') ? 'Yes' : 'No';
            var treatment_for_sti = $('#treatment_for_sti').is(':checked') ? 'Yes' : 'No';
            var hiv_aids_pid = $('#hiv_aids_pid').is(':checked') ? 'Yes' : 'No';

            var unpleasant_relationship = $('#unpleasant_relationship').is(':checked') ? 'Yes' : 'No';;
            var partner_does_not_approve = $('#partner_does_not_approve').is(':checked') ? 'Yes' : 'No';
            var domestic_violence = $('#domestic_violence').is(':checked') ? 'Yes' : 'No';
            ...
            $.ajax({
                ...
                data: {
                    ...
                    partner_does_not_approve: partner_does_not_approve,
                    domestic_violence: domestic_violence,
                    abnormal_discharge: abnormal_discharge,
                    genital_sores_ulcers: genital_sores_ulcers,
                    genital_pain_burning_sensation: genital_pain_burning_sensation,
                    treatment_for_sti: treatment_for_sti,
                    hiv_aids_pid: hiv_aids_pid,
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response === 'Success') {
                                ...
                                updateData();
                                Swal.fire('Inactive', 'The Family Planning Patient has been Inactive.', 'success');
                            } else {
