...
WHERE fp_consultation.medicine IS NULL AND nurses.user_id = $user_id AND fp_information.is_deleted = 0";
;
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <button type="button" class="btn btn-success editbtn2" data-row-id="<?php echo $row['id']; ?>"><i class="fas fa-edit"></i> Add Consultation </button>
                  ...
                  <!-- Form fields go here -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="editMethod" name="method" id="method" required>
                            ...
                            <option value="Emergency contraceptive pills">Emergency contraceptive pills</option>
                            <option value="Sterilization">Sterilization</option>
                            </select>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">View Family Planning</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div style="display: inline-block;" class="mt-1">
                ...
                <label for="client_type_new" class="radio-label" style="margin-left: 5px;">New Acceptor</label>
            </div>
            <div style="display: inline-block;">
            ...
            <div style="display: inline-block;">
                ...
                <label for="client_type_change_clinic" class="radio-label">Changing Clinic</label>
            </div>
            <div style="display: inline-block;">
