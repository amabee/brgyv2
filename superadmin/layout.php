            ...
            ?>">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item ml-2">
                    <a href="../consultation/consultation.php" class="nav-link <?php if ($_SERVER['REQUEST_URI'] === '/brgyv2/admin/consultation/consultation.php')
                      echo 'active'; ?>">
                ...
                <li class="nav-item ml-2">
                    <a href="../consultation/done_consultation.php" class="nav-link <?php if ($_SERVER['REQUEST_URI'] === '/brgyv2/admin/consultation/done_consultation.php')
                      echo 'active'; ?>">
                      <i class="fas fa-user-edit fa-lg nav-icon"></i>
                      <p>Done</p>
                    </a>
...
<script src="../superadmin/element/source.js"></script>
</body>
</html>
